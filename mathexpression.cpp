...
{
    RPN = new QVector<QString>;
    weightStack = new QStack<int>;
    weightTable = new QHash<QString, int>;
    operationsStack = new QStack<QString>;
    setWeightTable();
...
{
    QStack<double> *valuesStack = new QStack<double>;
    QVector<QString> *RPN_copy = new QVector<QString>;
